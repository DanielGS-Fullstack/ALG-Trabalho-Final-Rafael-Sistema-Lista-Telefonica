...
Critério	Pontuação
Funcionamento das funcionalidades obrigatórias	4,0
Uso correto de funções	2,0
Manipulação de arquivos	2,0
Organização, legibilidade e comentários	1,0
Tratamento de erros e validações	1,0
Total	10,0
